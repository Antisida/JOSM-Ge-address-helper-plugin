...
Функция плагина 'Удаление дублей' после получения данных присвоит адрес только строению с наибольшей площадью. Поэтому 
возникновение дублей возможно, когда в слое существует здание с адресом и оно меньше по площади, чем здание, для которого
