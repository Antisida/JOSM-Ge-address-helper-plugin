...
//                    geaddresshelperPlugin.cache.markProcessed(p, code)
//                    errors.add(
...
//            if (StringUtils.isNotBlank(it.parsedStreet.mostRelevantOsmName)) {
//                osmStreetNameEditBox.text = it.parsedStreet.mostRelevantOsmName
//            }
...
//        if (cmds.isNotEmpty()) {
//            val c: Command =
//                SequenceCommand(I18n.tr("Added tags from geaddresshelper CantParseAddress validator"), cmds)
//            geaddresshelperPlugin.cache.ignoreValidator(primitive, EGRNTestCode.getByCode(testError.code)!!)
//            return c
//        }
//
