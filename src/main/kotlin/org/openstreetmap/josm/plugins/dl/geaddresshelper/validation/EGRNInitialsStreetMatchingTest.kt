...
//                        val osmObjName = it.parsedStreet.mostRelevantOsmName
...
//                        affectedPrimitives = affectedPrimitives.plus(it.parsedStreet.matchingPrimitives.toSet())
...
//            val doubles = geaddresshelperPlugin.cleanFromDoubles(filteredPrimitives)
//            if (doubles.isNotEmpty()) {
//                val msg = I18n.tr("Duplicate addresses was not assigned")
//                val doublesAddresses =
//                    osmStreetName + doubles.map { geaddresshelperPlugin.cache.get(it)!!.addressInfo!!.getPreferredAddress()!!.parsedHouseNumber }
//                        .joinToString { ", " }
...
//                notification.show()
//            }
//            geaddresshelperPlugin.cache.ignoreValidator(doubles, EGRNTestCode.EGRN_STREET_MATCH_WITHOUT_INITIALS)
...
//                        geaddresshelperPlugin.cache.get(it)!!.addressInfo!!.getPreferredAddress()!!
...
//        if (cmds.isNotEmpty()) {
//            val c: Command =
//                SequenceCommand(I18n.tr("Added tags from geaddresshelper InitialsMatch validator"), cmds)
//            return c
//        }
//
//        return null
