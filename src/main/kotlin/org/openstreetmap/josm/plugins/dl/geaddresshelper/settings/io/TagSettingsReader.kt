...
class TagSettingsReader {
    companion object {
         ...
         * @since 0.2
         */
        val EGRN_ADDR_RECORD = BooleanProperty("dl.geaddresshelper.tag.egrn_addr_record", true)

        val EGRN_BUILDING_TYPES_SETTINGS = MapStringListProperty(
            "dl.geaddresshelper.tag.building_types_settings",
            mapOf(
        ...
        val ADDRESS_STOP_WORDS = ListProperty(
            "dl.geaddresshelper.tag.stop_words_list",
         ...
         */
        val OVERWRITE_ADDRESS = BooleanProperty("dl.geaddresshelper.tag.force_overwrite_address", true)
    }
}