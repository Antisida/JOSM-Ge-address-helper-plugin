...
//import org.openstreetmap.josm.plugins.dl.geaddresshelper.parsers.napr.N_ParsedAddress
...
// */
//
//class EGRN___FuzzyStreetMatchingTest : Test(
...
//            val nParsedAddresses : N_ParsedAddresses? = entry.value.address
//            val parsedAddressList = nParsedAddresses?.addresses ?: listOf()
//            for (parsedAddress in parsedAddressList) {
//                Logging.info("parsedAddress: $parsedAddress")
////                if (nParsedAddresses?.getPreferredAddress() == parsedAddress) {//тут один адрес у нас
//                    if (parsedAddress.parsedStreet.flags.contains(ParsingFlags.STREET_NAME_FUZZY_MATCH)
//                        && !primitive.hasTag("addr:street")
//                        && !entry.value.isIgnored(EGRNTestCode.EGRN_STREET_FUZZY_MATCHING)) {
//                        Logging.info("XXXXX: $entry")
//                        val parsedStreetName = parsedAddress.parsedStreet.extractedName
...
//        return testError.tester is EGRN___FuzzyStreetMatchingTest
//    }
//
//}
