...
//                geaddresshelperPlugin.cache.markProcessed(p, EGRNTestCode.EGRN_VALID_ADDRESS_ADDED)
//                errors.add(
//                    TestError.builder(
...
//
//        val preferredAddress = geaddresshelperPlugin.cache.get(primitive)?.addressInfo!!.getPreferredAddress()!!
//
...
//
//        if (StringUtils.isNotBlank(preferredAddress.parsedStreet.mostRelevantOsmName)) {
//            osmStreetNameEditBox.text = preferredAddress.parsedStreet.mostRelevantOsmName
//        }
...
//            geaddresshelperPlugin.cache.ignoreAllValidators(primitive)
//        }
//
//        if (cmds.isNotEmpty()) {
//            return SequenceCommand(I18n.tr("Modified tags from geaddresshelper AddressAdded validator"), cmds)
//        }
//
//        return null
//    }
