...
//        if (geaddresshelperPlugin.cache.isIgnored(p, EGRNTestCode.EGRN_ADDRESS_HAS_FLATS)) {
//            return
//        }
//
//        val egrnResponse = geaddresshelperPlugin.cache.get(p)
//
...
//                geaddresshelperPlugin.cache.markProcessed(p, EGRNTestCode.EGRN_ADDRESS_HAS_FLATS)
...
//
//        if (answer == 2) {
//            geaddresshelperPlugin.cache.ignoreValidator(primitive, EGRNTestCode.getByCode(testError.code)!!)
//            return null
//        }
//
//        if (cmds.isNotEmpty()) {
//            val c: Command =
//                SequenceCommand(I18n.tr("Added address nodes from geaddresshelper AddressHasFlats validator"), cmds)
//            geaddresshelperPlugin.cache.ignoreValidator(primitive, EGRNTestCode.getByCode(testError.code)!!)
//
//            return c
//        }
