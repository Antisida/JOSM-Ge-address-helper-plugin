...
//import org.openstreetmap.josm.plugins.dl.geaddresshelper.tools.TagHelper
//import org.openstreetmap.josm.plugins.dl.geaddresshelper.validation.gui.TagConflictSimpleDialog
...
//        val egrnResult = geaddresshelperPlugin.cache.get(p)
//        if (egrnResult != null && !geaddresshelperPlugin.cache.isIgnored(p, EGRNTestCode.EGRN_CONFLICTED_DATA)) {
//            val conflictedTags = getConflictedTags(egrnResult, p)
//
//            if (conflictedTags.isNotEmpty()) {
//                geaddresshelperPlugin.cache.markProcessed(p, EGRNTestCode.EGRN_CONFLICTED_DATA)
//                errors.add(
//                    TestError.builder(
...
//            primitive,
//            conflictedTags = getConflictedTags(geaddresshelperPlugin.cache.get(primitive)!!, primitive),
//            egrnAddress = geaddresshelperPlugin.cache.get(primitive)!!.addressInfo?.getPreferredAddress()?.egrnAddress,
//            *buttonTexts
//        )
//
//        dialog.showDialog()
...
//
//        if (answer == 1) {
//            geaddresshelperPlugin.cache.ignoreValidator(primitive, EGRNTestCode.EGRN_CONFLICTED_DATA)
