...
import org.openstreetmap.josm.plugins.dl.geaddresshelper.settings.io.LayerShiftSettingsReader
                        ...
                        for (i in 0 until nodes.size - 1) {
                            ...
                            if (Geometry.nodeInsidePolygon(Node(triangleCentroid), osmPrimitive.nodes)) {
                                if (CommonSettingsReader.ENABLE_DEBUG_GEOMETRY_CREATION.get()) {
                                    ...
                                    GeAddressHelperPlugin.createDebugObject(coords, triangleCentroid)
                                }
