...
//import org.openstreetmap.josm.plugins.dl.geaddresshelper.models.OSMAddress
...
//        val markedAsDoubles = geaddresshelperPlugin.cache.getProcessed(EGRNTestCode.EGRN_ADDRESS_DOUBLE_FOUND)
//            .filter { !geaddresshelperPlugin.cache.isIgnored(it.key, EGRNTestCode.EGRN_ADDRESS_DOUBLE_FOUND) }
...
//            }
//
//            if (geaddresshelperPlugin.cache.isIgnored(primitive, EGRNTestCode.EGRN_ADDRESS_DOUBLE_FOUND)) {
//                return@outer
//            }
//
//            val addressInfo = geaddresshelperPlugin.cache.get(primitive)!!.addressInfo
//            val coordinate =
//                geaddresshelperPlugin.cache.get(primitive)!!.coordinate ?: GeometryHelper.getPrimitiveCentroid(
//                    primitive
//                )
...
//
//        val primitive = affectedPrimitives.find { geaddresshelperPlugin.cache.contains(it) }
//        if (primitive == null) {
...
//            affectedPrimitives.filter { geaddresshelperPlugin.cache.contains(it) }
//                .map { geaddresshelperPlugin.cache.get(it)?.addressInfo?.getPreferredAddress() }
...
//                geaddresshelperPlugin.selectAction.actionPerformed(ActionEvent(this, 0, ""))
//                return null
//            }
...
//
//            geaddresshelperPlugin.cache.ignoreValidator(affectedPrimitives, EGRNTestCode.EGRN_ADDRESS_DOUBLE_FOUND)
//        }
//
//        if (answer == 4) {
//            //Assign to biggest
...
//                way is Way && way.hasKey("highway") && way.hasTag("name", duplicateAddress.parsedStreet.mostRelevantOsmName)
//            }
//            if (streets.isEmpty()) {
//                Notification(
