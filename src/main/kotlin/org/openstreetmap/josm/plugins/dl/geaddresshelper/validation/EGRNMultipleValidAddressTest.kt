...
//import org.openstreetmap.josm.plugins.dl.geaddresshelper.api.ParsedAddresses
//import org.openstreetmap.josm.plugins.dl.geaddresshelper.parsers.ParsedAddress
//import org.openstreetmap.josm.plugins.dl.geaddresshelper.tools.GeometryHelper
//import org.openstreetmap.josm.plugins.dl.geaddresshelper.validation.correction.AddressCorrection
//import org.openstreetmap.josm.plugins.dl.geaddresshelper.validation.correction.MultipleAddressCorrectionTable
...
//
//        if (geaddresshelperPlugin.cache.contains(p)) {
//            val data: ValidationRecord = geaddresshelperPlugin.cache.get(p)!!
//            val addressInfo = data.addressInfo ?: ParsedAddresses(listOf())
...
//            ) {
//                geaddresshelperPlugin.cache.markProcessed(p, EGRNTestCode.EGRN_HAS_MULTIPLE_VALID_ADDRESSES)
...
//
//        if (geaddresshelperPlugin.cache.contains(primitive)) {
//            val addressInfo = geaddresshelperPlugin.cache.get(primitive)?.addressInfo
//            affectedAddresses.addAll(addressInfo!!.getValidAddresses())
//        }
//
//        val doubledAddresses = geaddresshelperPlugin.findDoubledAddresses(affectedAddresses)
...
//                if (hasDouble) geaddresshelperPlugin.cache.markProcessed(
//                    primitive,
...
//
//        if (answer == 2) {
//            geaddresshelperPlugin.cache.ignoreValidator(testError.primitives, EGRNTestCode.getByCode(testError.code)!!)
//        }
//
//        if (cmds.isNotEmpty()) {
//            return SequenceCommand(I18n.tr("Added tags from geaddresshelper MultipleValidAddress validator"), cmds)
//        }
//        return null
//    }
//
