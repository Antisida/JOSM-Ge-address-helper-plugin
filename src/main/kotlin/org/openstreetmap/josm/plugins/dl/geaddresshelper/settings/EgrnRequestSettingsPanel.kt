package org.openstreetmap.josm.plugins.dl.geaddresshelper.settings
...
import org.openstreetmap.josm.plugins.dl.geaddresshelper.settings.io.SettingsSaver.Companion.saveDouble
import org.openstreetmap.josm.plugins.dl.geaddresshelper.settings.io.SettingsSaver.Companion.saveInteger
...
class EgrnRequestSettingsPanel : JPanel(GridBagLayout()) {
    ...
    fun initFromPreferences() {
        ...
        egrnTotalRequestsCounter.text =
            "${GeAddressHelperPlugin.totalRequestsPerSession}/${GeAddressHelperPlugin.totalSuccessRequestsPerSession}"
    ...
    fun saveToPreferences() {
        ...
        //debug call
        //geaddresshelperPlugin.cache.getUnprocessed()
    }
