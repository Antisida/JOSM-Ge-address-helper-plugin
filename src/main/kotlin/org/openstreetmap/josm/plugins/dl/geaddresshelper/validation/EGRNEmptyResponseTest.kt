...
//        val response = geaddresshelperPlugin.cache.get(p)?.data
//        if (response == null || response.responses.isEmpty()) {
//            if (geaddresshelperPlugin.cache.contains(p)) {
//                geaddresshelperPlugin.cache.markProcessed(p, EGRNTestCode.EGRN_RETURNED_EMPTY_RESPONSE)
//                errors.add(
...
//            val w = it.next()
//            if (w != null) {
//                geaddresshelperPlugin.cache.ignoreValidator(w, EGRNTestCode.getByCode(testError.code)!!)
//            }
//        }
//        return null
//    }
