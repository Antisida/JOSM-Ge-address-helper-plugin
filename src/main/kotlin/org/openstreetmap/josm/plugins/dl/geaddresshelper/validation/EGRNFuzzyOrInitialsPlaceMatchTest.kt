...
// * Можно присвоить распознанные адресные тэги, или игнорировать эту ошибку.
// */
...
//            }
//
//            geaddresshelperPlugin.cache.markProcessed(errorPrimitives, errorCode)
...
//            if (geaddresshelperPlugin.cache.responses[it] != null) {
//                val addressInfo = geaddresshelperPlugin.cache.responses[it]?.addressInfo
...
//            geaddresshelperPlugin.cache.ignoreValidator(doubles, EGRNTestCode.getByCode(testError.code)!!)
//            filteredPrimitives.forEach {
//                val prefferedAddress = geaddresshelperPlugin.cache.responses[it]!!.addressInfo!!.getPreferredAddress()
...
//                I18n.tr("Added tags from geaddresshelper Place has Fuzzy or Initials Match validator"),
//                cmds
//            )
//            return c
//        }
