...
//                Logging.warn("EGRN-PLUGIN Parsed street name ${streetParseResult.extractedName} by removing housenumber ${houseNumberParse.extractedNumber}, success ${cutStreetParse.extractedName}")
//                streetParseResult = cutStreetParse
//            } else {
//                Logging.warn("EGRN-PLUGIN Discard housenumber parsing result, because parsed street name ${streetParseResult.extractedName} overlaps with housenumber ${houseNumberParse.extractedNumber}")
//                houseNumberParse =
//                    ParsedHouseNumber(
//                        "",
//                        "",
...
//                Logging.warn("EGRN-PLUGIN Parsed place name ${streetParseResult.extractedName} by removing housenumber ${houseNumberParse.extractedNumber}, success ${cutPlaceParse.extractedName}")
//                placeParseResult = cutPlaceParse
//            } else {
//                Logging.warn("EGRN-PLUGIN Discard housenumber parsing result, because place name $placeParseAddress overlaps with housenumber ${houseNumberParse.extractedNumber}")
//                houseNumberParse =
//                    ParsedHouseNumber(
//                        "",
//                        "",
