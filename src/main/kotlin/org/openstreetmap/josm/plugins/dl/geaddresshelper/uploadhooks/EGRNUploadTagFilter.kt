...
class EGRNUploadTagFilter : UploadHook {
  override fun checkUpload(apiDataSet: APIDataSet): Boolean {
    ...
    val needsToRemove =
      apiDataSet.primitivesToAdd.filter {
        (it.hasTag("fixme", "REMOVE_ME!") ||
          it.hasTag("fixme", "REMOVE ME!") ||
          it.hasTag("DOUBLE", "ADDRESS") ||
    ...
    val discardableKeys: Collection<String> =
      setOf(
        "warn:1",
        "napr:addr:raw:1",
        "napr:addr:raw:2",
