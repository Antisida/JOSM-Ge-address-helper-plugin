...
//    }
    ...
    @Test
    fun moveToBack() {
        val actual = NStreetParser().moveToBack("ქუჩა ვაჟა ფშაველა", setOf("ქუჩა", "გამზირი", "ბულვარი", "ჩიხი", "შესახვევი", "გასასვლელი", "აღმართი"))
    ...
    @Test
    fun moveToBack1() {
        val actual = NStreetParser().moveToBack("შესახვევი I", setOf("ქუჩა", "გამზირი", "ბულვარი", "ჩიხი", "შესახვევი", "გასასვლელი", "აღმართი"))
    ...
    @Test
    fun moveToBack11() {
        val actual = NStreetParser().moveToBack("ქუჩა დემეტრე თავდადებულის", setOf("ქუჩა", "გამზირი", "ბულვარი", "ჩიხი", "შესახვევი", "გასასვლელი", "აღმართი"))

        assertEquals("დემეტრე თავდადებულის ქუჩა", actual)
    }
    @Test
    fun moveToBack111() {
        val actual = NStreetParser().moveToBack("ქუჩა გია აბესაძის", setOf("ქუჩა", "გამზირი", "ბულვარი", "ჩიხი", "შესახვევი", "გასასვლელი", "აღმართი"))
